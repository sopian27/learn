...
Current Lesson: 8.2 Spec-Driven Development sebagai Penyeimbang (selesai)

Next Lesson: 8.3 Disiplin Verifikasi. Mini Project Module 7 masih tertunda (vibe-code tool kecil "vibes only" + refleksi tertulis).
