...
- `astronomy-and-life-in-the-universe` — domains/astronomy-and-life-in-the-universe/DOMAIN.md — Status: Paused — Course: courses/astronomy-and-life-in-the-universe/roadmap.md
- `learning-science` — domains/learning-science/DOMAIN.md — Status: Paused — Course: courses/learning-science/roadmap.md
- `memory-mastery` — domains/memory-mastery/DOMAIN.md — Status: Paused — Course: courses/memory-mastery/roadmap.md
- `research-methods` — domains/research-methods/DOMAIN.md — Status: Paused — Course: courses/research-methods/roadmap.md
- `notulen-mastery` — domains/notulen-mastery/DOMAIN.md — Status: Paused — Course: courses/notulen-mastery/roadmap.md
- `emotional-resilience` — domains/emotional-resilience/DOMAIN.md — Status: Paused — Course: courses/emotional-resilience/roadmap.md
- `storytelling` — domains/storytelling/DOMAIN.md — Status: Paused — Course: courses/storytelling/roadmap.md
- `intuition-training` — domains/intuition-training/DOMAIN.md — Status: Paused — Course: courses/intuition-training/roadmap.md
- `realistic-manifestation` — domains/realistic-manifestation/DOMAIN.md — Status: Paused — Course: courses/realistic-manifestation/roadmap.md
- `chess-mastery` — domains/chess-mastery/DOMAIN.md — Status: Paused — Course: courses/chess-mastery/roadmap.md
- `poetry-appreciation` — domains/poetry-appreciation/DOMAIN.md — Status: Paused — Course: courses/poetry-appreciation/roadmap.md
- `art-appreciation` — domains/art-appreciation/DOMAIN.md — Status: Paused — Course: courses/art-appreciation/roadmap.md
- `westeros-history` — domains/westeros-history/DOMAIN.md — Status: Paused — Course: courses/westeros-history/roadmap.md
- `harry-potter` — domains/harry-potter/DOMAIN.md — Status: Paused — Course: courses/harry-potter/roadmap.md
- `middle-earth` — domains/middle-earth/DOMAIN.md — Status: Paused — Course: courses/middle-earth/roadmap.md
...
## Paused (2026-08-17, permintaan langsung user via background agent, dibuat saat Course Aktif "Character Development" di bawah 50% Module 1 — user eksplisit override guard `ai-los/COURSE_CREATION.md`)
...
## Paused (2026-08-19, permintaan langsung user, dibuat saat Course Aktif "Character Development" di bawah 50% Module 2/6 — user eksplisit konfirmasi override guard `ai-los/CLAUDE.md` lewat AskUserQuestion)

- `courage-to-try` — domains/courage-to-try/DOMAIN.md — Status: Paused — Course: courses/courage-to-try/roadmap.md
- `etiquette-essentials` — domains/etiquette-essentials/DOMAIN.md — Status: Paused — Course: courses/etiquette-essentials/roadmap.md

## Paused (2026-08-20, permintaan langsung user, dibuat saat Course Aktif "Character Development" di bawah 50% Module 2/6 — user eksplisit konfirmasi override guard `ai-los/CLAUDE.md` lewat AskUserQuestion)
...
## Paused (2026-08-30, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 module, Module 5 Mini Project & Module 6 log belum kelar) — user eksplisit konfirmasi lanjut lewat AskUserQuestion; course masih Draft menunggu approval)

- `live-your-youth` — domains/live-your-youth/DOMAIN.md — Status: Paused — Course: courses/live-your-youth/roadmap.md
...
## Paused (2026-09-04, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 module) — user eksplisit konfirmasi lanjut lewat AskUserQuestion; course standalone dipilih meski overlap parsial dengan `not-caring`/Module 8 `character-development`, dikonfirmasi lewat AskUserQuestion kedua — lihat "Registration History" di domain file)
...
## Paused (2026-09-05, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 module) — user eksplisit konfirmasi lanjut lewat AskUserQuestion; domain baru, tidak overlap dengan domain terdaftar manapun — lihat "Registration History" di domain file)
...
## Paused (2026-09-10, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 module) — user eksplisit konfirmasi lanjut lewat AskUserQuestion; course masih Draft menunggu approval)
...
## Paused (2026-09-25, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 modul) — user eksplisit konfirmasi lanjut lewat AskUserQuestion; scope standalone + cross-reference dipilih user meski overlap besar dengan `communication-skills`/`public-speaking`, domain baru adalah asumsi mentor — lihat "Registration History" di domain file; course masih Draft menunggu approval)
...
## Paused (2026-09-26, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 modul) dan `male-grooming` masih Module 1 — user eksplisit konfirmasi override guard lewat AskUserQuestion; scope "audit overlap dulu" dipilih user, nama domain `people-reading` adalah asumsi mentor — lihat "Registration History" di domain file; audit menemukan ±75-80% outline sudah punya rumah di `surrounded-by-idiots` Module 10/14, `intuition-training` Module 5, `the-hidden-game` Module 2-3/11, `emotional-resilience` Module 3-5, `communication-skills`/`pandai-bicara`/`never-split-the-difference`, sehingga course dilipat jadi 8 modul + capstone dengan label bukti eksplisit; riset menemukan akurasi deteksi kebohongan manusia ±54% dan stereotip tatapan mata tidak didukung; course masih Draft menunggu approval)

- `people-reading` — domains/people-reading/DOMAIN.md — Status: Paused — Course: courses/art-of-reading-people/roadmap.md

## Paused (2026-09-26, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 modul) dan `male-grooming` masih Module 1 — user eksplisit konfirmasi override guard lewat AskUserQuestion; scope "course standalone terlipat (~8 modul)" dipilih user setelah audit overlap (mentor sempat merekomendasikan tidak membuat course), nama domain `executive-leadership` adalah asumsi mentor — lihat "Registration History" di domain file; audit menemukan ±75-85% outline sudah punya rumah di `critical-thinking`/`engineering-culture`/`entrepreneurship`/`putin-code-strategic-thinking`/`tech-builder-mindset`/`business-knowledge`/`work-management`, sehingga course dilipat jadi 8 modul; riset menemukan buku asli Ty Wiggins berfokus pada CEO baru dengan daftar isi berbeda dari outline user, dan sumber buku adalah praktik/wawancara CEO oleh firma pencari eksekutif, sehingga course dibangun dengan label [Outline]/[Buku]/[Rujukan] dan label bukti eksplisit; course masih Draft menunggu approval)

- `executive-leadership` — domains/executive-leadership/DOMAIN.md — Status: Paused — Course: courses/the-new-ceo/roadmap.md

## Paused (2026-09-26, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 modul) — user eksplisit memilih "jadikan course terpisah" setelah mentor menjelaskan guard dan tiga opsi (draft saja / course terpisah / gabung ke `military-strategy` Module 2); nama domain `sun-tzu-strategy` adalah asumsi mentor — lihat "Registration History" di domain file; audit menemukan Sun Tzu hanya akademik di `military-strategy` Module 2 dan rujukan sekilas di course lain, sisi terapan belum ada; riset menemukan penulis/tanggal teks diperdebatkan, dua teks di Yinqueshan, dan kutipan viral tidak selalu ada di teks, sehingga course memakai label [Teks]/[Tafsir]/[Kerangka modern])

- `sun-tzu-strategy` — domains/sun-tzu-strategy/DOMAIN.md — Status: Paused — Course: courses/the-power-of-sun-tzu/roadmap.md

## Paused (2026-09-26, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 modul) dan `male-grooming` masih Module 1 — user eksplisit memilih "audit overlap dulu" lalu "course terlipat ~11 modul" lewat AskUserQuestion; nama domain `mathematics-for-software-engineers` adalah asumsi mentor — lihat "Registration History" di domain file; audit menemukan ±22 dari 40 modul outline sudah punya rumah di `computational-thinking`/`statistics-probability`/`ml-fundamentals`/`cryptography`/`performance-engineering`/`personal-finance`, sehingga course dilipat jadi 11 modul dengan label [Teorema/definisi/standar]/[Model/asumsi]/[Heuristik]; course masih Draft menunggu approval)

- `mathematics-for-software-engineers` — domains/mathematics-for-software-engineers/DOMAIN.md — Status: Paused — Course: courses/matematika-software-engineer/roadmap.md

## Paused (2026-09-26, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 modul) dan `male-grooming` masih Module 1 — user eksplisit konfirmasi override guard lewat AskUserQuestion; scope "audit overlap dulu" lalu "standalone terlipat ~8 modul" dipilih user, nama domain `applied-calculus` adalah asumsi mentor — lihat "Registration History" di domain file; audit menemukan ±55% topik outline sudah punya rumah di `ml-fundamentals` M3/M8, `neural-network`, `statistics-probability` M4-6, `physics-for-software-engineers` M6/M14, `performance-engineering`, sehingga course dilipat jadi 7 modul isi + capstone dengan label bukti eksplisit; course masih Draft menunggu approval)

- `applied-calculus` — domains/applied-calculus/DOMAIN.md — Status: Paused — Course: courses/kalkulus-untuk-software-engineer/roadmap.md

## Paused (2026-09-26, permintaan langsung user, dibuat saat Course Aktif "Character Development" pas di garis 50% (3/6 modul) dan `male-grooming` masih Module 1 — user eksplisit memilih "Audit overlap dulu" lewat AskUserQuestion (override guard); nama domain `nietzsche-philosophy` adalah asumsi mentor — lihat "Registration History" di domain file; audit menemukan Nietzsche sendiri belum ada di repo (hanya sebutan di `satanism` 6.2 dan `stoicism` 6.3) sedangkan tema praktis outline sudah tertutup `human-approval`/`not-caring`/`lowering-the-ego`/`live-your-youth`/`stoicism`/`digital-social-media-wisdom`, sehingga course dilipat jadi 14 modul dengan label [Teks]/[Tafsir]/[Adaptasi modern]; riset menandai "become what you are" dari Pindar, tafsir penderitaan outline bertentangan dengan BGE §225, dan kritik Nietzsche atas Stoik BGE §9; course masih Draft menunggu approval)
