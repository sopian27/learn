...
* **Backend Engineering Fundamentals Rebuild** — `courses/backend-fundamentals/roadmap.md` — Status: In Progress (Module 1 tuntas, skor Mini Project 90/100 — Module 2 Concurrency & Multithreading: semua lesson 2.1-2.5 tuntas (84/80/82/91/92), lanjut Mini Project Module 2) — **resume 2026-08-19 atas permintaan eksplisit user**, override kebijakan cap 2-course-aktif 2026-08-07 (slot Mastering Claude sudah selesai jadi user memilih isi dengan course ini alih-alih menganggap kosong).
