...
* **Mastering Claude — dari 0 sampai Expert** — `courses/mastering-claude/roadmap.md` — Status: In Progress (8/8 module selesai, Module 8 + Mini Project tuntas 2026-08-16) — track paralel/praktis, dimulai 2026-08-06; sisa Enterprise Project (acceptance criteria belum dirancang).
...
1. **Mastering Claude** (`courses/mastering-claude`) — semua 8 module tuntas, lanjutkan Enterprise Project (rancang acceptance criteria dulu).
