...
* **Personal Finance — dari 0 sampai Punya Rencana Keuangan Lengkap** — `courses/personal-finance/roadmap.md` — Domain: personal-finance — Status: In Progress (Module 1, Lesson 1.1) — roadmap di-approve 2026-08-06; pilot domain non-SWE pertama untuk memvalidasi arsitektur universal AI-LOS (lihat `ai-los/ARCHITECTURE_UNIVERSAL_LOS.md`), track paralel/independen dari Master Goal "World-Class Backend Developer" di atas — validasi apakah kernel domain-agnostic (`ai-los/CORE_LOS.md`) benar-benar jalan di luar software engineering
