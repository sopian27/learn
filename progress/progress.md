...
Current Lesson: 4.1 IoC Container & `ApplicationContext` — materi + Exercise/Task ditulis ke vault (2026-09-10), menunggu jawaban
Course Completion: 2/15 module (13%) — Module 1 & 2 tuntas penuh (termasuk Mini Project), Module 3 5/5 lesson selesai tapi Mini Project evidence Deliverable 2/4 belum tuntas (utang terbuka), Module 4 in progress (Lesson 4.1 diberikan)
...
| 4.1 IoC Container & `ApplicationContext`: bean definition, bean lifecycle (instantiation → DI → post-processing → destruction) | Materi diberikan (2026-09-10), menunggu jawaban | Belum dikerjakan |
